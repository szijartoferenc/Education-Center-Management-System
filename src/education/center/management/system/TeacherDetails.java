...
public class TeacherDetails extends JFrame implements ActionListener {
   ...
   TeacherDetails() {
        ...
        // Az adatbázisból lekérdezzük az összes  oktatói azonosítót a legördülő listába
        try {
            ...
            JOptionPane.showMessageDialog(null, "Hiba a oktatói kódok betöltésekor.");
        }
    ...
    private void loadTableData() {
        try {
            ...
            for (int i = 1; i <= columnCount; i++) {
                ...
                switch (name) {
                    case "empid": localizedHeaders[i - 1] = "Oktatói azonosító"; break;
                    ...
                    case "class_xii": localizedHeaders[i - 1] = "Alapdiploma"; break;
                    case "class_deg": localizedHeaders[i - 1] = "Mesterdiploma"; break;
            ...
            JOptionPane.showMessageDialog(null, "Hiba a oktatók adatainak betöltésekor.");
        }
    }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == search) {
            // Oktató keresése az azonosító alapján
            String selectedEmp = cEmpId.getSelectedItem();
            try {
                Conn c = new Conn();
                ResultSet rs = c.getStatement().executeQuery("SELECT * FROM teacher WHERE empId = '" + selectedEmp + "'");
                ResultSetMetaData metaData = rs.getMetaData();
                int columnCount = metaData.getColumnCount();
                ...
                for (int i = 1; i <= columnCount; i++) {
                    ...
                    switch (name) {
                        ...
                        case "class_deg": localizedHeaders[i - 1] = "Felsőfok"; break;
                        case "ssn": localizedHeaders[i - 1] = "TAJ"; break;
                        case "course": localizedHeaders[i - 1] = "Képzés"; break;
                        case "branch": localizedHeaders[i - 1] = "Szakirány"; break;
                        default: localizedHeaders[i - 1] = name;
            ...
            setVisible(false);
            new AddTeacher(); // Feltételezve, hogy van ilyen osztály
